...
class Token:
    ...
    def expires_at(self) -> float:
        ...
        # issued_at is guaranteed to be set by __post_init__
...
class OAuth2MobileAuth:
    ...
    def exchange_code_for_token(
        ...
        if not self.code_verifier:
            raise ValueError(
                "Code verifier not available - call generate_authorization_url first"
            )
    ...
    def _process_token_response(self, token_response: dict[str, Any]) -> Token | None:
        """
    ...
    def get_valid_token(self) -> Token | None:
        """
